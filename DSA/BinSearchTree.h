...
template<typename T>
BinNodePos<T>& BinSearchTree<T>::search(const T& e)
...
template<typename T>
BinNodePos<T> BinSearchTree<T>::insert(const T& e)
{
...
template<typename T>
BinNodePos<T> BinSearchTree<T>::rotateAt(BinNodePos<T> v)
{
...
template<typename T>
BinNodePos<T> BinSearchTree<T>::connect34(BinNodePos<T> a,
                                          BinNodePos<T> b,
                                          BinNodePos<T> c,
                                          BinNodePos<T> T0,
                                          BinNodePos<T> T1,
